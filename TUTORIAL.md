...
```
(ROCm-gdb) b rocm:50
GPU breakpoint 4 (PC:0x022c ld_kernarg_align(8)_width(all)_u64  $d1, [%inputA]; temp_source@line 50)
(ROCm-gdb) c
Continuing.
[New Thread 0x7ffeeddcb700 (LWP 13642)]
Waiting for completion...
[ROCm-gdb]: Breakpoint: 4	at ld_kernarg_align(8)_width(all)_u64  $d1, [%inputA];
Stopped on GPU breakpoint
[Switching to Thread 0x7ffeeddcb700 (LWP 13642)]

(ROCm-gdb) step
[ROCm-gdb]: Breakpoint: 	at line 52
Stopped on GPU breakpoint

(ROCm-gdb) s
[ROCm-gdb]: Breakpoint: 	at line 53
Stopped on GPU breakpoint

(ROCm-gdb) s
[ROCm-gdb]: Breakpoint: 	at line 54
Stopped on GPU breakpoint
